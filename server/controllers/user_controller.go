...
import (
	...
	"github.com/didmcelik/go-react-application/models"
	"github.com/didmcelik/go-react-application/responses"
...
func EditAUser() http.HandlerFunc {
	return func(rw http.ResponseWriter, r *http.Request) {
		...
		update := bson.M{"email": user.Email, "username": user.Username}
